...
@section('breadcrumb')
<li>
    <a href="{{ URL::to('entry/entrylistele') }}">Entry Listele</a>
</li>
@stop
@section('alttitle')
<h1 id="main-heading">
        ...
        <div class="widget-content table-container">
            <table class="table table-striped data">
                ...
                <tbody>
                    ...
                    <td width="10%">
                        <a href="{{ URL::to('entry/entryduzenle/'.$entrys->id.'') }}" class="btn btn-mini btn-primary">Düzenle</a>
                        <a onclick="return confirm('Seçili Entry Silmek İstediğinizden Eminmisiniz ? ')" href="{{ URL::to('entry/entrysil/'.$entrys->id.'') }}" class="btn btn-mini btn-danger">Sil</a>
                    </td>
                    </tr>
                    @endforeach
