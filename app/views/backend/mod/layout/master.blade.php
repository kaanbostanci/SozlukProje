                    ...
                    <link rel="stylesheet" href="{{ URL::to('Backend/plugins/uniform/css/uniform.default.css') }}" media="screen">
                        ...
                        <link rel="stylesheet" href="{{ URL::to('Backend/assets/css/fonts/icomoon/style.css') }}" media="screen">
                            <link rel="stylesheet" href="{{ URL::to('Backend/assets/css/main-style.css') }}" media="screen">
                                ...
                                <![endif]-->
                                @yield('css')
                                <title>@if(isset($title))Mku Sozluk - {{$title}} @else Mku Sozluk @endif</title>

                                </head>

                                <body data-show-sidebar-toggle-button="true" data-fixed-sidebar="false">
                                <div id="wrapper">
                                    @include('backend.mod.layout.header')
                                    <div id="content-wrap">
                                        <div id="content">
                                            <div id="content-outer">
                                                <div id="content-inner">
                                                    @include('backend.mod.layout.sidebar')
                                                    <section id="main" class="clearfix">
                                                        @include('backend.mod.layout.breadcrumb')	
                                                        <div id="main-content">
                                                            @yield('content')
                                                        </div>   
                                                    </section>
                                    ...
                                    @include('backend.mod.layout.footer')   
                                </div>
                                <!-- Core Scripts -->
                                ...
                                <!-- Global js -->
                                <script src="{{ URL::to('Backend/global/global.js') }}"></script>
