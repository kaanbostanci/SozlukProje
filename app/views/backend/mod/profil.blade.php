...
@section('breadcrumb')
<li>
    <a href="{{ URL::to('modpanel/profil') }}">Profil Güncelle</a>
</li>
@stop
@section('alttitle')
<h1 id="main-heading">
    ...
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-content form-container">
                <form class="form-horizontal validate" action="{{ URL::to('modpanel/profil') }}" method="post" enctype="Multipart/form-data">
