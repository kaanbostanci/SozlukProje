...
@section('breadcrumb')
<li>
    <a href="{{ URL::to('modentry/entryduzenle/'.$entry->id.'') }}">Entry Düzenle</a>
</li>
@stop
@section('alttitle')
<h1 id="main-heading">
    ...
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-content form-container">
                <form class="form-horizontal validate" action="{{ URL::to('modentry/entryduzenle/'.$entry->id.'') }}" method="post">
