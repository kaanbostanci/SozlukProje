...
class Backend_EntryController extends BackendController {
    /*
      |--------------------------------------------------------------------------
    ...
    public function getEntrylistele(){
        $entryler = Entry::all();
        return View::make('backend.entry.listele',array('entry'=>$entryler));
    }
    ...
    public function getEntryduzenle($id){
       $entry = Entry::findOrFail($id);
       return View::make('backend.entry.duzenle',array('entry'=>$entry));
    }
